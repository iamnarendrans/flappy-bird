...
#include "images.h" // flappy bird image
#include "fontovi.h"  // font ovi file

SSD1306Wire  display(0x3c, 21, 22);  // Initializing a OLED display

#define DEMO_DURATION 3000   // Total Variable declearation (Time)
...
pinMode(23,OUTPUT); //Buzzer input
pinMode(4,INPUT_PULLUP);  //Pulling input that is push button
  ...
  display.flipScreenVertically();  // Fliping screen Vertically
  display.setFont(ArialMT_Plain_10);  // Font what I choosed
